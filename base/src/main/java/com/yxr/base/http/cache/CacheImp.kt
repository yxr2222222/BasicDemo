...
class CacheImp(cacheConfig: CacheConfig) : Closeable, Flushable, ICache {
    ...
    private class Entry {
        ...
        fun matches(request: Request, response: Response): Boolean {
            return url == request.url && requestMethod == request.method
        }
    ...
    companion object {
        ...
        fun useExpiredData(useExpiredData: Boolean) = apply {
            Companion.useExpiredData = useExpiredData
        }
